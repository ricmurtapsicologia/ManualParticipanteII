...
export default function Home() {
  ...
  return (
    <div className="shell" data-testid="reader-shell" data-page-count={pages.length} data-wave="4">
      <header className="top">
        <div className="topin">
          <div className="mark">CATS</div>
          <div className="brand"><strong>Manual do Participante CATS</strong><span>Rebuild limpo • Onda 4 • 50 páginas reais</span></div>
          <div className="tools">
