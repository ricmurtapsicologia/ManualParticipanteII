...
if(report.pages!==246||JSON.stringify(report.removedSourcePages)!==JSON.stringify([2,4,5])) throw new Error('Wave10 final pagination proof missing');
