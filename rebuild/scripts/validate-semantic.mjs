...
if (semantic.manifest.chapterCount !== 34) fail(`Expected 34 chapters, got ${semantic.manifest.chapterCount}`);
...
console.log(
  `SEMANTIC_VALIDATE_OK pages=249 parts=7 chapters=34 blocks=${blockCount} ` +
