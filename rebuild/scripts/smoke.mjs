...
try {
  ...
  for (const token of ['Manual do Participante CATS', 'Edição Digital Interativa', `data-page-count="${health.pages}"`, 'data-testid="approved-cover"', 'canonicalCoverFrame', 'manual-cats-capa-digital-2026.jpg']) if (!html.includes(token)) throw new Error(`Home missing token: ${token}`);
